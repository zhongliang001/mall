<template>
  <div>
        ...
        <el-main>
          ...
          >
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="父菜单id" size="default" prop="parentId">
                  <el-input
                    name="el-input"
                    :min-rows="2"
                    type="text"
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="菜单路径" size="default" prop="path">
                  <el-input
                    name="el-input"
                    :min-rows="2"
                    type="text"
    ...
    <el-Dialog ref="updateDialog" v-model="isUpdateShow" title="修改菜单">
      <el-container>
        <el-main>
          <el-form
            :model="updateMenu"
          ...
          >
            <el-row>
              <el-col :span="12">
                <el-form-item label="菜单id" size="default" prop="menuId">
                  <el-input
                    name="el-input"
                    :min-rows="2"
                    type="text"
              ...
              <el-col :span="12">
                <el-form-item label="父菜单id" size="default" prop="parentId">
                  <el-input
                    ...
                    placeholder="父菜单id"
                    @blur="checkParentId(updateMenu, updateDialog)"
                  />
                </el-form-item>
              </el-col>
              <el-col :span="12">
            ...
            <el-form-item label-width="0" style="text-align: center">
              <zl-button ref="updateBtn" :disabled="false" @click="saveUpdate"
                >保存</zl-button
              >
    ...
    <el-Dialog ref="viewDialog" v-model="isViewShow" title="查看菜单">
      <el-container>
        <el-main>
  ...
  setup(props, ctx) {
    ...
    const checkParentId = (menu: any, addDialog: any) => {
      if (addDialog.visible) {
        ...
        const url =
          service.userURL + '/menu/checkParentId?menuId=' + menu.parentId
        service.request({
          method: 'post',
          url: url,
          success: function (rep: rep) {
    ...
    const del = () => {
      if (state.currentRow.menuId !== '') {
        ...
        ElMessageBox.confirm('此操作将永久删除该数据, 是否继续?', '提示', {
          ...
          .then(() => {
            const url =
              service.userURL + '/menu/delete?menuId=' + state.currentRow.menuId
            service.request({
              method: 'post',
              url: url,
              success: function (rep: rep) {
