          ...
          <el-row>
            ...
            <el-col :span="11">
              <el-form-item label="购买者id" prop="buyerId">
                <zl-input-cur v-model="formdata.buyerId"></zl-input-cur>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="11">
              <el-form-item label="平台订单号" prop="platOrderId">
                <zl-input-cur v-model="formdata.platOrderId"></zl-input-cur>
              </el-form-item>
            </el-col>

            <el-col :span="11">
              <el-form-item label="采购订单号" prop="vendorOrderId">
                <zl-input-cur v-model="formdata.vendorOrderId"></zl-input-cur>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
